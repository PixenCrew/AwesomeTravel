...
public class OpenApiService {
    ...
    public void fetchAndSaveData() throws UnsupportedEncodingException {
        ...
        String SERVICE_KEY = "LlzmSnhpn+oy0xRuNRMG8B7zoQQFfiaIkqMpw6ZfXw1HGSiYmOUPwwNSq1mayIkaQED3E5GUYYzHGX92CVXYgQ=="
                .trim();
        ...
        // .orElseThrow(() -> new IllegalArgumentException("항공사 [" + item.getAirline() +
        // "] 는 미등록 항공사입니다."));
        // // DB 저장을 위한 엔티티 변환
        // Air air = new Air(
