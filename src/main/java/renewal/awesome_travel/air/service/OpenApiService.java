...
public class OpenApiService {
    ...
    // String SERVICE_KEY =
    // "LlzmSnhpn+oy0xRuNRMG8B7zoQQFfiaIkqMpw6ZfXw1HGSiYmOUPwwNSq1mayIkaQED3E5GUYYzHGX92CVXYgQ=="
    // .trim();
    ...
    // .queryParam("serviceKey", encodedKey) // 여기서는 trim() 후, RestTemplate이 자동
    // 인코딩하도록 함
    ...
    // // try {
    // // ApiResponse apiResponse = restTemplate.getForObject(uri,
    // ApiResponse.class);
    ...
    // // .orElseThrow(() -> new IllegalArgumentException("항공사 [" +
    // item.getAirline() +
    // // "] 는 미등록 항공사입니다."));
    // // // DB 저장을 위한 엔티티 변환
    // // Air air = new Air(
